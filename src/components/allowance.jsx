        ...
        <div className="container">
          ...
          <div className="centered-white">
            <a
              onClick={() => {
                window.open(
                  "https://github.com/James-Sangalli/eth-allowance/blob/master/src/helpers/dapps.js",
                );
              }}
            >
              Add dApp
        ...
        <div className="allowance">
          <div className="container">
            ...
            <div className="centered">
              <a href={this.props.etherscanURL + this.props.tx.contract}>
                {this.truncateName(this.props.tx.contractName)}
              </a>
            </div>
          </div>
          ...
          <div className="container">
            <img className="container" src={textBoxMedium} alt="" />
            <div className="centered">
              <a href={this.props.etherscanURL + this.props.tx.approved}>
                {this.truncateName(this.props.tx.approvedName)}
              </a>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="centered-white">
              <a name="revoke" id="revokeLink" onClick={this.setRevokeClick}>
                Revoke
              </a>
            </div>
          </div>
